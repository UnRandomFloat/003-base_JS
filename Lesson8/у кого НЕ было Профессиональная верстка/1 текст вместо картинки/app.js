...
function showMoreText(card) {
    ...
    let textToShow="Это какой нибудь текс которым нужно заменить картинку";
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML("beforeend", `<div class="desc">${textToShow}</div>`);
